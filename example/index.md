...
subcategory: ""
description: |-
  Use the Formal provider to interact with the many resources supported by Formal. You must configure the provider with the proper credentials before you can use it.
...
many resources supported by Formal. You must configure the provider

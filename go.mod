...
require (
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.11-20260211024928-d9bfe3113c8a.1
...
require (
	buf.build/gen/go/formal/core/connectrpc/go v1.19.1-20260211024928-d9bfe3113c8a.2 // indirect

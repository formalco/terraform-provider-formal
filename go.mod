...
require (
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.8-20250905032652-add00645e833.1
...
require (
	...
	buf.build/gen/go/formal/core/connectrpc/go v1.18.1-20250821213748-f6c01e0b4276.1 // indirect

...
require (
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.11-20260526123456-578cb24eeadb.1
...
require (
	buf.build/gen/go/formal/core/connectrpc/go v1.20.0-20260526123456-578cb24eeadb.1 // indirect

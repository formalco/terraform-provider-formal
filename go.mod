...
require (
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.5-20250222030534-4e62b55a015e.1
...
require (
	...
	buf.build/gen/go/formal/core/connectrpc/go v1.18.1-20250222030534-4e62b55a015e.1 // indirect

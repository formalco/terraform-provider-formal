...
require (
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.6-20250324021135-686fff576454.1
...
require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.36.6-20240920164238-5a7b106cbb87.1 // indirect

...
require (
	buf.build/gen/go/formal/core/protocolbuffers/go v1.36.11-20251224211923-c6799348c49c.1
...
require (
	buf.build/gen/go/formal/core/connectrpc/go v1.19.1-20251219200635-0335f6990fa2.2 // indirect

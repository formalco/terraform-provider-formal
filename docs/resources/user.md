...
- `expire_at` (Number) When the user should be deleted and access revoked. Value should be provided in Unix epoch time, in seconds since midnight UTC of January 1, 1970. Cannot be set together with termination_protection.
...
- `termination_protection` (Boolean) If set to true, this User cannot be deleted. Cannot be set together with expire_at.
